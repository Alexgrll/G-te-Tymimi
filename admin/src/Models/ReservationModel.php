...
class ReservationModel extends Model {
    ...
    public function readAll() {
        $query = "SELECT reservations.*, utilisateurs.id AS id_utilisateur, 
                                        utilisateurs.nom_utilisateur AS nom_utilisateur, 
                                        utilisateurs.prenom_utilisateur AS prenom_utilisateur, 
                                        utilisateurs.email_utilisateur AS email_utilisateur, 
                                        utilisateurs.telephone_utilisateur AS telephone_utilisateur 
                FROM {$this->table} JOIN utilisateurs ON reservations.id_utilisateur_reservation = utilisateurs.id";
